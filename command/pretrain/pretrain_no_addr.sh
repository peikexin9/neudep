...
rm checkpoints/pretrain_no_addr -rf

mkdir -p checkpoints/pretrain_no_addr
...
TORCH_DISTRIBUTED_DEBUG=DETAIL CUDA_VISIBLE_DEVICES=0,1,2,3 python train.py \
  data-bin/pretrain \
