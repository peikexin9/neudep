...
CHECKPOINT_PATH=checkpoints/finetune_table3_all_concat
rm -rf $CHECKPOINT_PATH
mkdir -p $CHECKPOINT_PATH
cp checkpoints/pretrain_concat/checkpoint_best.pt $CHECKPOINT_PATH/
...
CUDA_VISIBLE_DEVICES=1 python train.py \
  ...
  --byte-combine concat --num-workers 4 --skip-invalid-size-inputs-valid-test |
  tee result/finetune_table3_all_concat
