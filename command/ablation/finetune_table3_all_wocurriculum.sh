...
CHECKPOINT_PATH=checkpoints/finetune_table3_all_wocurriculum
rm -rf $CHECKPOINT_PATH
mkdir -p $CHECKPOINT_PATH
cp checkpoints/pretrain_wocurriculum/checkpoint_best.pt $CHECKPOINT_PATH/
...
CUDA_VISIBLE_DEVICES=0 python train.py \
  ...
  tee result/finetune_table3_all_wocurriculum
