...
CHECKPOINT_PATH=checkpoints/finetune_table3_all_fusing_5
rm -rf $CHECKPOINT_PATH
mkdir -p $CHECKPOINT_PATH
cp checkpoints/pretrain_fusing_5/checkpoint_best.pt $CHECKPOINT_PATH/
...
CUDA_VISIBLE_DEVICES=0 python train.py \
  ...
  --input-combine fuse --fuse-layer 5 --beta-shift 1e-1 --fuse-dropout 1e-1 \
  --byte-combine cnn --num-workers 4 --skip-invalid-size-inputs-valid-test |
  tee result/finetune_table3_all_fusing_5
