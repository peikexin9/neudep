...
CHECKPOINT_PATH=checkpoints/finetune_table3_all_fusing_sum
rm -rf $CHECKPOINT_PATH
mkdir -p $CHECKPOINT_PATH
cp checkpoints/pretrain_fusing_sum/checkpoint_best.pt $CHECKPOINT_PATH/
...
CUDA_VISIBLE_DEVICES=2 python train.py \
  ...
  tee result/finetune_table3_all_fusing_sum
